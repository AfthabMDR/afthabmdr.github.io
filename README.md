# Afthab's thought-provoking thoughts

### A simple blog website to write thoughts and ideas that are interesting to me.
...
```
    ...
    4. Go to actions tab, search for hugo workflow, select it,  and make the commit.
```
